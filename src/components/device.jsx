...
function Device() {
    ...
    return (
        <div className="">
            ...
            {addDevicePopupActive ? (<div className="absolute top-20 ml-72 bg-purple-50 w-1/3 h-2/3 rounded-xl shadow-2xl" >
                <div className="bg-purple-200 h-20 rounded-t-xl flex">
                    <label className="text-3xl mt-5 ml-5 " >Add Device</label>
                    <div className="mt-6 ml-36 bg-white h-5 w-5 rounded-xl hover:bg-purple-500 mr-5 pl-1 pb-2 cursor-pointer" onClick={onClickCancelButton}>x</div>
                </div>
                <div>
                    <table className="mt-5">
                        <tr>
                            <td>
                                <label className="text-xl ml-20 w-20 p-5 pb-5">Type </label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label className="text-lg ml-20 w-20 p-5 pb-5">Model </label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label className="text-lg ml-20 w-20 p-5 pb-5">ID </label>
                            </td>
                            <td>
                    ...
                    <div className="flex ml-56 mt-20">
                            <div className="w-20 h-10 bg-purple-200 rounded pl-6 pt-2 hover:bg-purple-400 cursor-pointer" onClick={addDevice}>
                                <label>Add</label>
                            </div>
                            <div className="w-24 h-10 bg-gray-200 rounded pl-6 pt-2  ml-5 hover:bg-purple-200 cursor-pointer" onClick={onClickCancelButton}>
                                <label>Cancel</label>
                            </div>
                        </div>
